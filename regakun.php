        ...
        <div class="bg-primary bg-opacity-25 p-4 rounded shadow mt-5">
            <form method="POST" action="proses-laporan.php" class="mt-4 p-4 border rounded shadow-sm bg-white">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-1 text-center">:</div>
                    <div class="col-sm-8">
                        <input type="text" name="lokasi" class="form-control bg-light" placeholder="Contoh: Bilabok@gmail.com" value="Bilabok@gmail.com" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-1 text-center">:</div>
                    <div class="col-sm-8">
                        <input type="text" name="waktu" class="form-control bg-light" placeholder="Contoh: Jl. Palawaran 1, Gang Salak" value="Jl. Palawaran 1, Gang Salak" required>
                    </div>
                </div>
