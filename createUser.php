<?php
    ...
    include 'controller/user/create.php';
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $error = createUser($nama, $email,$password, $lokasi_id);
    }
        ...
        <div class="bg-primary bg-opacity-25 p-4 rounded shadow mt-5">
            <form method="POST" class="mt-4 p-4 border rounded shadow-sm bg-white">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="nama" class="form-control bg-light" placeholder="Nama lengkap" required>
                    </div>
                </div>
